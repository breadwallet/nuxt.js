...
function createWebpackMiddleware () {
  ...
  clientConfig.entry.app = _.flatten(['webpack-hot-middleware/client?reload=true&dynamicPublicPath=true', clientConfig.entry.app])
  ...
  this.webpackDevMiddleware = pify(require('webpack-dev-middleware')(clientCompiler, Object.assign(clientConfig.devServer||{},{
